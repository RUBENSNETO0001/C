...
int main() {
    ...
    do {
        ...
        switch (opcao) {
            case 1: // Adicionar pessoa em uma lista
                printf("Digite o �ndice da lista (0-%d): ", MAX_LISTAS - 1);
                scanf("%d", &indice);
            ...
            case 7: // Comparar duas listas
                printf("Digite os �ndices das duas listas para comparar (0-%d): ", MAX_LISTAS - 1);
                int indice2;
                scanf("%d %d", &indice, &indice2);
                if (compararListas(listas[indice], listas[indice2])) {
                    printf("As listas s�o iguais.\n");
                } else {
                    printf("As listas s�o diferentes.\n");
                }
                clear();
                break;

            case 8: // Verificar repeti��o de ID
                printf("Digite o �ndice da lista (0-%d): ", MAX_LISTAS - 1);
                scanf("%d", &indice);
                printf("Digite o ID a verificar: ");
                scanf("%d", &id);
                if (verificarRepeticaoId(listas[indice], id)) {
                    printf("O ID %d est� repetido na lista.\n", id);
                } else {
                    printf("O ID %d n�o est� repetido.\n", id);
                }
                clear();
                break;
    ...
    // Liberar mem�ria das listas antes de encerrar
    for (int i = 0; i < MAX_LISTAS; i++) {
