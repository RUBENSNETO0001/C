...
//Função topoPilha() - retornar o elemento que está no topo
...
//Função compararElementos() - com base no código - Utilizar o campo codLivro

//E no processo de desempilhamento como é feito a limpeza do 
//elemento da memória - liberação de memória

//Função para buscar repetição de "livros" na pilha
//1. Verifica topo
//2. Compara topo com os outros elementos
//3. Decrementa topo
//4. Compara topo com os outros elementos

//Função para alterar valores de atributos de uma struct livro da pilha - após
